...
async function _getBasicInfo(id, options, isFromGetInfo) {
    ...
    if (!HTML5_PLAYER_URL) {
        throw new errors_1.UnrecoverableError(`HTML5Player was not found, please report it via Issues (${SHIM.info.issuesUrl}).`);
    }
    /* Initialization */
